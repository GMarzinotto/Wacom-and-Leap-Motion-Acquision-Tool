...
namespace WacomTabletApplication {
    ...
    /// Summary for DataM12
    /// </summary>
    public ref class DataM12 : public System::Windows::Forms::Form
    {
    public: String^ currentLanguage;
            Patient* myPatient;
    public:
        DataM12(Patient *inputPatient, String^ language, bool treatAsNew)
        {
            InitializeComponent();
            currentLanguage = language;
            myPatient = inputPatient;
//            UpdateLanguage_DataM12Form(currentLanguage);
        }
    ...
    private: void WacomTabletApplication::DataM12::UpdateLanguage_DataM12Form(String^ language);
...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
            ...
            this->YES_OTHERS_RADIOBUTTON->CheckedChanged += gcnew System::EventHandler(this, &DataM12::YES_OTHERS_RADIOBUTTON_CheckedChanged);
            // 
            ...
            this->YES_EMOTIONS_RADIOBUTTON->CheckedChanged += gcnew System::EventHandler(this, &DataM12::YES_EMOTIONS_RADIOBUTTON_CheckedChanged);
            // 
            ...
            this->YES_ALCOHOL_RADIOBUTTON->CheckedChanged += gcnew System::EventHandler(this, &DataM12::YES_ALCOHOL_RADIOBUTTON_CheckedChanged);
            // 
            ...
            this->YES_TREATMENT_RADIOBUTTON->CheckedChanged += gcnew System::EventHandler(this, &DataM12::YES_TREATMENT_RADIOBUTTON_CheckedChanged);
            // 
            ...
            this->YES_DIAGNOSE_RADIOBUTTON->CheckedChanged += gcnew System::EventHandler(this, &DataM12::YES_DIAGNOSE_RADIOBUTTON_CheckedChanged);
            // 
            ...
            this->YES_PATHOLOGY_RADIOBUTTON->CheckedChanged += gcnew System::EventHandler(this, &DataM12::YES_PATHOLOGY_RADIOBUTTON_CheckedChanged);
            // 
            ...
            this->YES_HOSPITALIZATION_RADIOBUTTON->CheckedChanged += gcnew System::EventHandler(this, &DataM12::YES_HOSPITALIZATION_RADIOBUTTON_CheckedChanged);
            // 
            ...
            this->YES_SURGERY_RADIOBUTTON->CheckedChanged += gcnew System::EventHandler(this, &DataM12::YES_SURGERY_RADIOBUTTON_CheckedChanged);
            // 
            ...
            this->CANCEL_BUTTON->Click += gcnew System::EventHandler(this, &DataM12::CANCEL_BUTTON_Click);
            // 
            // REGISTER_BUTTON
            // 
            ...
            this->REGISTER_BUTTON->Click += gcnew System::EventHandler(this, &DataM12::REGISTER_BUTTON_Click);
            // 
            // DataM12
            // 
            ...
            this->Name = L"DataM12";
            this->Text = L"DataM12";
            this->Load += gcnew System::EventHandler(this, &DataM12::DataM12_Load);
...
private: System::Void DataM12_Load(System::Object^  sender, System::EventArgs^  e) {
}
};
}
